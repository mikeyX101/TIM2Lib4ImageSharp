...
{
    public class ColorCodec16BitLEABGR : ColorCodec<Abgr32>
    {
        public override Abgr32[] DecodeColors(byte[] palette, int start, int size)
        {
            List<Abgr32> pal = new List<Abgr32>();
            ...
            for (int i = 0; i < size / 2; i++)
            {
                ...
                pal.Add(new Abgr32(ImageUtils.Conv5To8(red), ImageUtils.Conv5To8(green), ImageUtils.Conv5To8(blue), alpha));
            }
        ...
        public override byte[] EncodeColors(Abgr32[] colors, int start, int length)
        {
