...
namespace TIM2Lib4ImageSharp.ImgLib.Formats.Serialization
{
    ...
    /// serializer.
    /// </summary>
    public interface TextureFormatSerializer<TPixel> where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        TextureFormat<TPixel> Open(Stream formatData);
        ...
        void Save(TextureFormat<TPixel> texture, Stream outFormatData);
        ...
        void Export(TextureFormat<TPixel> texture, MetadataWriter metadata, string directory, string basename);
        ...
        /// <param name="metadata"></param>
        /// <param name="directory"></param>
        TextureFormat<TPixel> Import(MetadataReader metadata, string directory);
    }
}
